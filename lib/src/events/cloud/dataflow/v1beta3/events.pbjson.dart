...
@$core.Deprecated('Use jobStatusChangedEventDescriptor instead')
...
/// Descriptor for `JobStatusChangedEvent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List jobStatusChangedEventDescriptor = $convert.base64Decode(
