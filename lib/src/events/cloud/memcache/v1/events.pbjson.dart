...
//
// Generated from google/events/cloud/memcache/v1/events.proto.
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.events.cloud.memcache.v1.InstanceEventData',
      '10': 'data'
    },
  ],
  '7': {},
...
final $typed_data.Uint8List instanceCreatedEventDescriptor = $convert.base64Decode(
    'ChRJbnN0YW5jZUNyZWF0ZWRFdmVudBJGCgRkYXRhGAEgASgLMjIuZ29vZ2xlLmV2ZW50cy5jbG'
    '91ZC5tZW1jYWNoZS52MS5JbnN0YW5jZUV2ZW50RGF0YVIEZGF0YTo7svjYLClnb29nbGUuY2xv'
    'dWQubWVtY2FjaGUuaW5zdGFuY2UudjEuY3JlYXRlZMr42CwIaW5zdGFuY2U=');
...
final $typed_data.Uint8List instanceUpdatedEventDescriptor = $convert.base64Decode(
    'ChRJbnN0YW5jZVVwZGF0ZWRFdmVudBJGCgRkYXRhGAEgASgLMjIuZ29vZ2xlLmV2ZW50cy5jbG'
    '91ZC5tZW1jYWNoZS52MS5JbnN0YW5jZUV2ZW50RGF0YVIEZGF0YTo7svjYLClnb29nbGUuY2xv'
    'dWQubWVtY2FjaGUuaW5zdGFuY2UudjEudXBkYXRlZMr42CwIaW5zdGFuY2U=');
...
final $typed_data.Uint8List instanceDeletedEventDescriptor = $convert.base64Decode(
    'ChRJbnN0YW5jZURlbGV0ZWRFdmVudBJGCgRkYXRhGAEgASgLMjIuZ29vZ2xlLmV2ZW50cy5jbG'
    '91ZC5tZW1jYWNoZS52MS5JbnN0YW5jZUV2ZW50RGF0YVIEZGF0YTo7svjYLClnb29nbGUuY2xv'
    'dWQubWVtY2FjaGUuaW5zdGFuY2UudjEuZGVsZXRlZMr42CwIaW5zdGFuY2U=');
