...
//
// Generated from google/events/cloud/pubsub/v1/events.proto.
...
class MessagePublishedEvent extends $pb.GeneratedMessage {
  ...
  MessagePublishedEvent._();

  factory MessagePublishedEvent.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MessagePublishedEvent.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.MessagePublishedData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: $0.MessagePublishedData.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MessagePublishedEvent clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $0.MessagePublishedData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($0.MessagePublishedData value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.MessagePublishedData ensureData() => $_ensure(0);
}
